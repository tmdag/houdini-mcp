...
def version_sorted(names):
    ...
    sorted(reverse=True) on strings ranks "Houdini 9.5" above
    "Houdini 22.0.429" and hfs9.5 above hfs22.0.
    """
    def key(name):
...
def main():
    ...
    if args.bridge:
        ...
        print("Houdini launched. Start the MCP bridge separately with: .venv/bin/python houdini_mcp_server.py")
